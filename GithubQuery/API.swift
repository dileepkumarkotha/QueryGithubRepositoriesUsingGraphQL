...
public final class SearchRepositoriesQuery: GraphQLQuery {
  ...
  public let operationDefinition =
    "query SearchRepositories($queryString: String!, $count: Int!, $afterCursor: String) { search(query: $queryString, type: REPOSITORY, first: $count, after: $afterCursor) { __typename repositoryCount pageInfo { __typename startCursor endCursor hasNextPage } edges { __typename cursor node { __typename ... on Repository { ...RepositoryDetails } } } } }"
  ...
  public init(queryString: String, count: Int, afterCursor: String? = nil) {
  ...
  public var variables: GraphQLMap? {
    return ["queryString": queryString, "count": count, "afterCursor": afterCursor]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("search", arguments: ["query": GraphQLVariable("queryString"), "type": "REPOSITORY", "first": GraphQLVariable("count"), "after": GraphQLVariable("afterCursor")], type: .nonNull(.object(Search.selections))),
    ]
...
public struct RepositoryDetails: GraphQLFragment {
  ...
  public static let fragmentDefinition =
    "fragment RepositoryDetails on Repository { __typename name owner { __typename avatarUrl login } stargazers { __typename totalCount } }"
